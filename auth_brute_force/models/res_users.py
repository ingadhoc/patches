...
class ResUsers(models.Model):
    ...
    @classmethod
    def _auth_attempt_force_raise1(cls, login, method):
    ...
    @classmethod
    def _auth_attempt_new1(cls, login):
    ...
    @classmethod
    def _auth_attempt_update1(cls, values):
    ...
    @classmethod
    def _login1(cls, db, login, password):
    ...
    @classmethod
    def authenticate1(cls, db, login, password, user_agent_env):
        return cls._auth_attempt_force_raise(
            login,
    ...
    @api.model
    def check_credentials1(self, password):
